...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
  ...
  return (
    <div className='m-2'>
      ...
      {postHovered && (
        <div
          className='absolute top-0 w-full h-full flex flex-col justify-between p-1 ppr-2 pt-2 pb-2 z-50'
          style={{height: '100%'}}
        >
          <div className='flex items-center justify-between'>
            ...
            {alreadySaved? (
              ...
              type='botton' className='bg-red-500 opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none'>
                {save?.length}  Save
              </button>
            )}
          </div>
